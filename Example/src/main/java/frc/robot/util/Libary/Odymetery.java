...
import frc.robot.util.Libary.PoseTracker.FOMdataOdymetry;
...
public class Odymetery {
  ...
  public static void setGyroValues(GyroValues gyroValues) {
    Odymetery.gyroValues = gyroValues;
  }
  ...
  private static StructPublisher<Pose2d> posePublisher =
      NetworkTableInstance.getDefault().getStructTopic("OdymetryPurePose", Pose2d.struct).publish();
  ...
  public static void UseSkidInFOMClaclations(
      SwerveDriveKinematics kinematics, double Threashould, double SkidMagnitude) {
    Odymetery.SkidMagnitude = SkidMagnitude;
    Odymetery.SkidThreashould = Threashould;
    Odymetery.kinematics = kinematics;
  ...
  private static double getSkiddingRatio(
